...
public:
    ...
    void Print_podar(CBinTreeNode<T>* n);
    void Print_podar2(CBinTreeNode<T>* n);
    void Print_podar3(CBinTreeNode<T>* n, int level);
    void Print_podar4(CBinTreeNode<T>* n, int level);
...
template <class T>
void CBinTree<T>::Print_podar(CBinTreeNode<T>* n)
{
    if (!root) return;
...
template <class T>
void CBinTree<T>::Print_podar2(CBinTreeNode<T>* n)
{
    if (!root) return;
    int cantidad = MaxDepth(root);
    CBinTreeNode<T>* tmp = new CBinTreeNode<T>(-1);
...
template <class T>
void CBinTree<T>::Print_podar3(CBinTreeNode<T>* n, int level)
{
    if (!n) return;
    Print_podar3(n->nodes[1], level + 1);
    ...
    Print_podar3(n->nodes[0], level + 1);
}

template <class T>
void CBinTree<T>::Print_podar4(CBinTreeNode<T>* n, int level)
{
    if (!n) return;
    Print_podar4(n->nodes[1], level - 1);
    for (int i = 0; i < level; i++)
    {
        fich << "	";
    }
    ...
    fich << std::endl;
    Print_podar4(n->nodes[0], level - 1);
}
...
int main()
{
    ...
    t.Ins(2000);
    t.Ins(9999);
    t.Print_podar(t.Root());
    fich << "================================================================================================================" << std::endl;
    t.Print_podar2(t.Root());
    fich << "================================================================================================================" << std::endl;
    t.Print_podar3(t.Root(), 0);
    fich << "================================================================================================================" << std::endl;
    t.Print_podar4(t.Root(), t.MaxDepth(t.Root()));
    if (!fich)
    {
